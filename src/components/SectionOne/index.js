  ...
  return (
    <div>
      <Row justify="space-around" align="middle">
        <Col xs={24} sm={4} md={6} lg={14} xl={14}>
          <Title style={{ color: "#fff", fontSize: "64px" }}>
            Serving customers all over the{" "}
            <span style={{ color: "#F3A400" }}>INDIA</span>
          </Title>
          ...
          >
            Read case studies or visit projects that our <br />
            customers have built with Meribachat.
          </Title>
          <button
            type="primary"
