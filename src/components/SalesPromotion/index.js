...
export default function SalesPromotion({ header }) {
  return (
    <div className="sales-promotion">
      <Title style={{ color: "#fff" }} className="sales-promotion-heading">
        {header}
      </Title>
      <br />
      <Row justify="center">
        <Col xs={12} sm={12} md={12} lg={6} xl={6}>
          <SalesBox
            ...
            salesBoxText={"Personalised Coupons"}
          />
        </Col>
        <Col xs={12} sm={12} md={12} lg={6} xl={6}>
          <SalesBox
      ...
      <Row justify="center">
        ...
        <Col xs={12} sm={12} md={12} lg={6} xl={6}>
          <SalesBox
            ...
            salesBoxText={"In-cart promotion"}
          />
        </Col>
      </Row>
    </div>
